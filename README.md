...
### [Course 3: Natural Language Processing in TensorFlow](https://www.coursera.org/learn/natural-language-processing-tensorflow/home/welcome)
  ...
  I have seen a good >25% increase in accuracy by using embeddings which are trained in larger corpus and have high dimentions (>=300d). This helps in both reducing OOV problem and having good (more accurate) embedding vectors. So be careful of using high dimentional embedding if you are using pretrained embeddings. Also it is imporant to remove stopwords, and use lemmatize (NLTK WordNetLemmatizer etc) and other form of prepocessing. Use of NLTK for these type of task is fairly common.
